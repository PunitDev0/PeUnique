...
export default function PaymentGatewayFeatures() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Align your payment experience with your brand by customizing payment pages for better user engagement and higher conversions.",
...
function Feature({ feature, xInitial, scrollYProgress, index, featuresLength }) {
  ...
  return (
    ...
    {/* Floating Image */}
    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 w-16 h-16 rounded-full flex items-center justify-center backdrop-blur-sm bg-gradient-to-br from-white/20 via-transparent to-black/20 shadow-lg">
      <img src={feature.image} alt={feature.title} className="h-full w-full rounded-full object-cover" />
    </div>
